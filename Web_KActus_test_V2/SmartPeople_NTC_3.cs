    ...
    public class SmartPeople_NTC_3 : FuncionesVitales
    {
        ...
        public void SmartPeople_frmNmVicapNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test_V2.SmartPeople_NTC_3.SmartPeople_frmNmVicapNTC")
                {
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 11) for (int i = 0; i < 12; i++) SendKeys.Send("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmRHFdForDesaNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test_V2.SmartPeople_NTC_3.SmartPeople_frmRHFdForDesaNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmRHNmLiqViENTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test_V2.SmartPeople_NTC_3.SmartPeople_frmRHNmLiqViENTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 10) for (int i = 0; i < 15; i++) SendKeys.Send("{DOWN}");
        ...
        public void SmartPeople_frmRHSLRepSLNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test_V2.SmartPeople_NTC_3.SmartPeople_frmRHSLRepSLNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 4) for (int i = 0; i < 4; i++) SendKeys.Send("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmRHSoEpactNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test_V2.SmartPeople_NTC_3.SmartPeople_frmRHSoEpactNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 9) for (int i = 0; i < 13; i++) SendKeys.Send("{DOWN}");
                                        if (counter == 18) for (int i = 0; i < 14; i++) SendKeys.Send("{DOWN}");
                                        if (counter == 28) for (int i = 0; i < 8; i++) SendKeys.Send("{DOWN}");
                                    }
                                    ...
                                    /////////// Validación TABS ////////
                                    //selenium.Click(xpath[0]);
                                    for (int i = 0; i < 35; i++) SendKeys.Send("{UP}");
                                    List<IWebElement> elementList = new List<IWebElement>();
                                    //List<IWebElement> elementListPagina2 = new List<IWebElement>();
                                    Thread.Sleep(800);
                                    elementList.AddRange(driver.FindElements(By.XPath("//*[contains(@name,'ctl00$ContenidoPagina$')]")));
        ...
        public void SmartPeople_frmBiTrinvNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test_V2.SmartPeople_NTC_3.SmartPeople_frmBiTrinvNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmEdInforme360NTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test_V2.SmartPeople_NTC_3.SmartPeople_frmEdInforme360NTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmLlBiHvintLNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test_V2.SmartPeople_NTC_3.SmartPeople_frmLlBiHvintLNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
