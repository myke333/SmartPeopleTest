    ...
    public class SmartPeople_NTC_2 : FuncionesVitales
    {
        ...
        public void PruebaGrabacion()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.PruebaGrabacion")
                {
        ...
        public void SmartPeople_frmAcMafunDNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmAcMafunDNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmBiEdforNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmBiEdforNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 4) for (int i = 0; i < 8; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmBiEdnfoNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmBiEdnfoNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmBiEmpdoNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmBiEmpdoNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 5) for (int i = 0; i < 6; i++) Keyboard.SendKeys("{DOWN}");
                                    }
                                    ...
                                    for (int k = 0; k < 10; k++) Keyboard.SendKeys("{UP}");
                                    Thread.Sleep(100);
                                    selenium.Screenshot("Campos Necesarios", true, file);
        ...
        public void SmartPeople_frmBiEdnfoCNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmBiEdnfoCNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmBiFamilNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmBiFamilNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 12) for (int i = 0; i < 8; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 21) for (int i = 0; i < 8; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmBiHvextNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmBiHvextNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 19) for (int i = 0; i < 13; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 25) for (int i = 0; i < 3; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmBiPeFunRNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmBiPeFunRNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    //    }
                                    //}
                                    for (int i = 0; i < 3; i++) Keyboard.SendKeys("{DOWN}");
                                    //selenium.Click("//a[contains(@id,'ctl00_btnNuevo')]");
        ...
        public void SmartPeople_frmBpSopreNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmBpSopreNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 13) for (int i = 0; i < 12; i++) Keyboard.SendKeys("{DOWN}");
                                    ...
                                    /////////// Validación TABS ////////
                                    //selenium.Click("//div[@id='ctl00_pBotones']/div");
                                    for (int i = 0; i < 12; i++) Keyboard.SendKeys("{UP}");
                                    List<IWebElement> elementList = new List<IWebElement>();
                                    //List<IWebElement> elementListPagina2 = new List<IWebElement>();
                                    Thread.Sleep(800);
                                    elementList.AddRange(driver.FindElements(By.XPath("//*[contains(@name,'ctl00$ContenidoPagina$')]")));
        ...
        public void SmartPeople_frmBpSopreSiNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmBpSopreSiNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 18) for (int i = 0; i < 12; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 25) for (int i = 0; i < 3; i++) Keyboard.SendKeys("{DOWN}");
                                    ...
                                    /////////// Validación TABS ////////
                                    //selenium.Click("//div[@id='ctl00_pBotones']/div");
                                    for (int i = 0; i < 16; i++) Keyboard.SendKeys("{UP}");
                                    List<IWebElement> elementList = new List<IWebElement>();
                                    //List<IWebElement> elementListPagina2 = new List<IWebElement>();
                                    Thread.Sleep(800);
                                    elementList.AddRange(driver.FindElements(By.XPath("//*[contains(@name,'ctl00$ContenidoPagina$')]")));
        ...
        public void SmartPeople_frmEdFomeiFNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmEdFomeiFNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 11) for (int i = 0; i < 11; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 20)
                                        {
                                            for (int i = 0; i < 11; i++) Keyboard.SendKeys("{UP}");
        ...
        public void SmartPeople_frmEdFomeiFEmerNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmEdFomeiFEmerNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 10) for (int i = 0; i < 12; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 16)
                                        {
                                            for (int i = 0; i < 12; i++) Keyboard.SendKeys("{UP}");
        ...
        public void SmartPeople_frmEdFomeiRFNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmEdFomeiRFNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 8) for (int i = 0; i < 13; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 9) for (int i = 0; i < 11; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 22)
                                        {
                                            for (int i = 0; i < 24; i++) Keyboard.SendKeys("{UP}");
                                            selenium.Click("//a[contains(@id,'nav-evaluador-tab')]");
                                            Thread.Sleep(100);
                                            selenium.Screenshot("Segunda Pestaña", true, file);
                                    ...
                                    for (int i = 0; i < 4; i++) Keyboard.SendKeys("{DOWN}");
                                    selenium.Click("//input[contains(@id,'ctl00_ContenidoPagina_btnAplicar')]");
                                    Thread.Sleep(500);
                                    //xpath=//a[@id='btnGuardar']
                                    selenium.Screenshot("Campos Necesarios", true, file);
        ...
        public void SmartPeople_frmFdSoproNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmFdSoproNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 9) for (int i = 0; i < 12; i++) Keyboard.SendKeys("{DOWN}");
                                        ...
                                        if (counter == 19)
                                        {
                                            for (int i = 0; i < 2; i++) Keyboard.SendKeys("{UP}");
        ...
        public void SmartPeople_frmLIEdFomeiANTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmLIEdFomeiANTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 8) for (int i = 0; i < 17; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 13) for (int i = 0; i < 4; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 21)
                                        {
                                            for (int i = 0; i < 18; i++) Keyboard.SendKeys("{UP}");
                                            selenium.Click("//a[contains(@id,'nav-evaluador-tab')]");
                                        }
                                        if (counter == 26) for (int i = 0; i < 15; i++) Keyboard.SendKeys("{UP}");
                                    }
        ...
        public void SmartPeople_frmLIEdFomeiTNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmLIEdFomeiTNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 8) for (int i = 0; i < 18; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 21)
                                        {
                                            for (int i = 0; i < 18; i++) Keyboard.SendKeys("{UP}");
                                            selenium.Click("//a[contains(@id,'nav-evaluador-tab')]");
        ...
        public void SmartPeople_frmLINmAplvaNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmLINmAplvaNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    for (int i = 0; i < 13; i++) Keyboard.SendKeys("{UP}");
                                    List<IWebElement> elementList = new List<IWebElement>();
                                    //List<IWebElement> elementListPagina2 = new List<IWebElement>();
                                    Thread.Sleep(800);
                                    elementList.AddRange(driver.FindElements(By.XPath("//*[contains(@name,'ctl00$ContenidoPagina$')]")));
        ...
        public void SmartPeople_frmLISlReqpeNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmLISlReqpeNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 9) for (int i = 0; i < 2; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 12) for (int i = 0; i < 19; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 16) for (int i = 0; i < 10; i++) Keyboard.SendKeys("{DOWN}");
                                    }
                                    ...
                                    /////////// Validación TABS ////////
                                    selenium.Click("//div[@id='ctl00_pBotones']/div");
                                    for (int i = 0; i < 30; i++) Keyboard.SendKeys("{UP}");
                                    //ChromeDriver driver = selenium.returnDriver();
                                    List<IWebElement> elementList = new List<IWebElement>();
                                    Thread.Sleep(800);
                                    elementList.AddRange(driver.FindElements(By.XPath("//*[contains(@name,'ctl00$ContenidoPagina$')]")));
        ...
        public void SmartPeople_frmLISlReqpeDianNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmLISlReqpeDianNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 12) for (int i = 0; i < 15; i++) Keyboard.SendKeys("{DOWN}");
                                    }
                                    ...
                                    /////////// Validación TABS ////////
                                    selenium.Click("//div[@id='ctl00_pBotones']/div");
                                    for (int i = 0; i < 15; i++) Keyboard.SendKeys("{UP}");
                                    //ChromeDriver driver = selenium.returnDriver();
                                    List<IWebElement> elementList = new List<IWebElement>();
                                    Thread.Sleep(800);
                                    elementList.AddRange(driver.FindElements(By.XPath("//*[contains(@name,'ctl00$ContenidoPagina$')]")));
        ...
        public void SmartPeople_frmLISlReqpeHNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmLISlReqpeHNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 10) for (int i = 0; i < 13; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 28) for (int i = 0; i < 14; i++) Keyboard.SendKeys("{DOWN}");
                                    ...
                                    /////////// Validación TABS ////////
                                    //selenium.Click(xpath[0]);
                                    for (int i = 0; i < 23; i++) Keyboard.SendKeys("{UP}");
                                    List<IWebElement> elementList = new List<IWebElement>();
                                    //List<IWebElement> elementListPagina2 = new List<IWebElement>();
                                    Thread.Sleep(800);
                                    elementList.AddRange(driver.FindElements(By.XPath("//*[contains(@name,'ctl00$ContenidoPagina$')]")));
        ...
        public void SmartPeople_frmLISlReqpeTemNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmLISlReqpeTemNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 9) for (int i = 0; i < 14; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 15) for (int i = 0; i < 10; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmNmCtperNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmNmCtperNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        if (counter == 9) for (int i = 0; i < 5; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 11)
                                        {
                                            for (int i = 0; i < 6; i++) Keyboard.SendKeys("{UP}");
        ...
        public void SmartPeople_frmNmCtperDNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmNmCtperDNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmNmRcappANTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmNmRcappANTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmNmSanciDNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmNmSanciDNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        if (counter == 11) for (int i = 0; i < 15; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 17)
                                        {
                                            for (int i = 0; i < 3; i++) Keyboard.SendKeys("{DOWN}");
        ...
        public void SmartPeople_frmBpBeotoDNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmBpBeotoDNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 9) for (int i = 0; i < 15; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmBpSolceNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmBpSolceNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmCoEncueNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmCoEncueNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmCoEncueLVNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmCoEncueLVNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmCoEncueLVRNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmCoEncueLVRNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmCoEncueTNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmCoEncueTNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmFdClsesNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmFdClsesNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmNmAntcaNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmNmAntcaNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 15) for (int i = 0; i < 8; i++) Keyboard.SendKeys("{DOWN}");
                                    }
                                    ...
                                    /////////// Validación TABS ////////
                                    //selenium.Click(xpath[0]);
                                    for (int i = 0; i < 8; i++) Keyboard.SendKeys("{UP}");
                                    List<IWebElement> elementList = new List<IWebElement>();
                                    //List<IWebElement> elementListPagina2 = new List<IWebElement>();
                                    Thread.Sleep(800);
                                    elementList.AddRange(driver.FindElements(By.XPath("//*[contains(@name,'ctl00$ContenidoPagina$')]")));
        ...
        public void SmartPeople_frmNmApldeNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmNmApldeNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmNmAplvaDNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmNmAplvaDNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 13) for (int i = 0; i < 3; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmNmConMarcLNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmNmConMarcLNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmNmConviaNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmNmConviaNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 17) for (int i = 0; i < 12; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 22) for (int i = 0; i < 6; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmNmDviclNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmNmDviclNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmNmNotcajNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_2.SmartPeople_frmNmNotcajNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 15) for (int i = 0; i < 6; i++) Keyboard.SendKeys("{DOWN}");
                                    }
