    ...
    public class SmartPeople_NTC_4 : FuncionesVitales
    {
        ...
        public void SmartPeople_frmBpBevenNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmBpBevenNTC")
                {
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 6) for (int i = 0; i < 10; i++) Keyboard.SendKeys("{DOWN}");
        ...
        public void SmartPeople_frmBpBevenDNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmBpBevenDNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 8) for (int i = 0; i < 7; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmBpSopreENTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmBpSopreENTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 15) for (int i = 0; i < 7; i++) Keyboard.SendKeys("{DOWN}");
        ...
        public void SmartPeople_frmBiHerraNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmBiHerraNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmNmOpreDNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmNmOpreDNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmLNmOprecNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmLNmOprecNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmNmCaltuANTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmNmCaltuANTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmBiFamNmBenLNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmBiFamNmBenLNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmFdPlcurNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmFdPlcurNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmFdSocueNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmFdSocueNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmGnSclavNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmGnSclavNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmEd3dlicNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmEd3dlicNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        if (counter == 11) for (int i = 0; i < 10; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmEd3dlicPPNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmEd3dlicPPNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        if (counter == 11) for (int i = 0; i < 20; i++) Keyboard.SendKeys("{DOWN}");
        ...
        public void SmartPeople_frmFdDplinNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmFdDplinNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 12) for (int i = 0; i < 5; i++) Keyboard.SendKeys("{DOWN}");
                                    }
                                    ...
                                    /////////// Validación TABS ////////
                                    //selenium.Click(xpath[0]);
                                    for (int i = 0; i < 5; i++) Keyboard.SendKeys("{UP}");
                                    List<IWebElement> elementList = new List<IWebElement>();
                                    //List<IWebElement> elementListPagina2 = new List<IWebElement>();
                                    Thread.Sleep(800);
                                    elementList.AddRange(driver.FindElements(By.XPath("//*[contains(@name,'ctl00$ContenidoPagina')]")));
        ...
        public void SmartPeople_frmNmAntcaDNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmNmAntcaDNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        if (counter == 15) for (int i = 0; i < 14; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmNmCtpreNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmNmCtpreNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmNmCtperLhNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmNmCtperLhNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmFdDplinCNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmFdDplinCNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 12) for (int i = 0; i < 6; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmFdNeforDNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmFdNeforDNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 14) for (int i = 0; i < 11; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmLINmCtprePNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_4.SmartPeople_frmLINmCtprePNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
