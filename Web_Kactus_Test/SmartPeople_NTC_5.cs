    ...
    public class SmartPeople_NTC_5 : FuncionesVitales
    {
        ...
        public void Prueba_NTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_5.Prueba_NTC")
                {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    //for (int i = 0; i < ; i++) Keyboard.SendKeys("{UP}");
        ...
        public void SmartPeople_frmLIBiEdforNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_5.SmartPeople_frmLIBiEdforNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 6) for (int i = 0; i <= 4; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmLIBiEdnfoNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_5.SmartPeople_frmLIBiEdnfoNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        if (counter == 6) for (int i = 0; i < 2; i++) Keyboard.SendKeys("{DOWN}");
                                    }
        ...
        public void SmartPeople_frmLIBiEmplNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_5.SmartPeople_frmLIBiEmplNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(2000);
                                        if (counter == 5) for (int i = 0; i < 14; i++) Keyboard.SendKeys("{DOWN}");
                                        if (counter == 20) for (int i = 0; i < 4; i++) Keyboard.SendKeys("{DOWN}");
        ...
        public void SmartPeople_frmLIBiEmplLNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_5.SmartPeople_frmLIBiEmplLNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                try
                                {
                                    ...
                                    */
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(100);
                                        //if (counter == 5) for (int i = 0; i < 15; i++) Keyboard.SendKeys("{DOWN}");
        ...
        public void SmartPeople_frmLIBiEntprNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_5.SmartPeople_frmLIBiEntprNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void SmartPeople_frmLIBiHvextNTC()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Web_Kactus_Test.SmartPeople_NTC_5.SmartPeople_frmLIBiHvextNTC")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                            ...
                            if (rowCounter == (CamposTotalesMTM.Count))
                            {
                                ...
                                try
                                {
                                    ...
                                    foreach (var element in campos)
                                    {
                                        ...
                                        counter++;
                                        Thread.Sleep(1000);
                                        if (counter == 17) for (int i = 0; i < 13; i++) Keyboard.SendKeys("{DOWN}");
                                    }
